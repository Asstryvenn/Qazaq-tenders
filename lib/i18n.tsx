...
const kz = {
  nav: { how: "Қалай жұмыс істейді", engine: "Мүмкіндіктер", dashboard: "Тендер нарығы", open: "Симуляторды ашу", login: "Кіру", register: "Тіркелу", logout: "Шығу", profile: "Профиль" },
  ...
  hero: {
    ...
    titleMid: "Зияткерлік экономикалық симулятор",
    titleTail: "шағын және орта бизнеске арналған сатып алулар үшін",
    subtitle:
  ...
  landing: {
    ...
    features: [
      ...
      { title: "Сценарийлік сезімталдық", body: "Отын, жеткізуші бағасы және төлем кешігуі слайдерлері TOS пен пайданы нақты уақытта қайта есептейді." },
  ...
  flow: {
    steps: [
      ...
      { title: "JSON талдау", sub: "AI қабаты · 1-қабат", detail: "LLM тек фактілерді шығарады: S, D, P_delay, K_delay, сертификаттар. Бірде-бір қаржылық есеп жоқ." },
      { title: "Математика қозғалтқышы", sub: "Экономика · 2-қабат", detail: "Детерминистік формулалар: Π, M_rel, күнделікті CF_t, L_score, R_legal. Бірдей кіріс — бірдей нәтиже." },
      { title: "Тендер нарығы", sub: "Шешім", detail: "0–100 индексі, кассалық алшақтық графигі және тәуекелдердің түсінікті тізімі." },
    ],
  },
  dash: {
    title: "Тендер нарығы",
  ...
  onb: {
    ...
    regime: "Салық режимі",
    regimes: {
      general: { title: "Жалпыға бірдей режим", desc: "ҚҚС-сыз, пайдадан КТС 20%" },
      simplified: { title: "Оңайлатылған декларация", desc: "Кірістен 4%, ҚҚС-сыз" },
      vat: { title: "ҚҚС төлеуші", desc: "ҚҚС 16% + пайдадан КТС 20%" },
    },
...
const ru: Dict = {
  nav: { how: "Как работает", engine: "Возможности", dashboard: "Рынок тендеров", open: "Открыть симулятор", login: "Войти", register: "Регистрация", logout: "Выйти", profile: "Профиль" },
  ...
  hero: {
    ...
    titleMid: "Интеллектуальный экономический симулятор",
    titleTail: "для закупок малого и среднего бизнеса",
    subtitle:
    ...
    card: { active: "Активный лот", margin: "Маржа", gap: "Разрыв", none: "нет", reach: "Плечо", flow: "Денежный поток · 60 дней", deferral: "отсрочка 30 дней" },
  },
  landing: {
    archEyebrow: "Архитектура",
    ...
    ctaButton: "Открыть рынок тендеров",
    ...
    features: [
      ...
      { title: "Сценарный анализ чувствительности", body: "Слайдеры топлива, цены поставщика и задержки оплаты пересчитывают TOS и прибыль в реальном времени." },
  ...
  flow: {
    steps: [
      ...
      { title: "Парсинг в JSON", sub: "AI-слой · Слой 1", detail: "LLM только извлекает факты: S, D, P_delay, K_delay, сертификаты. Ни одного финансового расчёта." },
      { title: "Математический движок", sub: "Экономика · Слой 2", detail: "Детерминированные формулы: Π, M_rel, посуточный CF_t, L_score, R_legal. Одинаковый вход — одинаковый выход." },
      { title: "Рынок тендеров", sub: "Решение", detail: "Индекс 0–100, график кассового разрыва и понятный список рисков." },
    ],
  },
  dash: {
    title: "Рынок тендеров",
    ...
    cfSub: "CF_t = CF₀ + Σ приходов − Σ расходов, посуточно",
  ...
  onb: {
    ...
    regimes: {
      general: { title: "Общеустановленный режим", desc: "Без НДС, КПН 20% с прибыли" },
      simplified: { title: "Упрощённая декларация", desc: "4% с дохода, без НДС" },
      vat: { title: "Плательщик НДС", desc: "НДС 16% + КПН 20% с прибыли" },
    },
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    document.title = lang === "kz" ? "Qazaq Tenders — бизнеске арналған тендер симуляторы" : "Qazaq Tenders — экономический симулятор тендеров";
  }, [lang]);
